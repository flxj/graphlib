...
func Contains[K comparable, W number](g1 Graph[K, W], g2 Graph[K, W]) (bool, error) {
	if g1 == nil || g2 == nil {
...
func SpanningSubgraph[K comparable, W number](g Graph[K, W], edges [][]K) (Graph[K, W], error) {
	if g == nil {
...
func SpanningSupergraph[K comparable, W number](g Graph[K, W], edges []*Edge[K, W]) (Graph[K, W], error) {
	if g == nil {
		return nil, errNilGraph
	}
	ng, err := g.Clone()
...
func InducedSubgraph[K comparable, W number](g Graph[K, W], vertexes []K) (Graph[K, W], error) {
	if g == nil {
		return nil, errNilGraph
	}
	ng, err := g.Clone()
